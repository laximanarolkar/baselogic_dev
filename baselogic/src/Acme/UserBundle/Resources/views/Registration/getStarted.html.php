				...
				<div class="QTPopupCntnr">
					<div class="mainpopup">						
						...
						<div style="height:120px;"> <!--class="main_loginbox"-->
							...
							<a href="<?php echo $view['router']->generate('_twitter_sign_in')?>"><img src="<?php echo $view['assets']->getUrl('bundles/userbundle/style/images/twitter-login.png')?>" title="Click here to sign in with Twitter!" style="height:22px;"/></a>
							<!--<div id="status"></div>-->
							<hr>
						<!--Sign in-->
