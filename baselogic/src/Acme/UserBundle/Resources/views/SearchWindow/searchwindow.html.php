...
// populates the manufacturer, style and options dropdown   ---starts    
$(document).ready(function() {
	...
	onItemClick: function(checkbox, selector){
		...
		var checkCount = (justChecked) ? 1 : -1;
			...
			//sets the limit on number of items that can be selected in the dd
			  if ( checkCount > 5 ) {
				alert( "Limit is 5" );
				throw "too many";
			}
	...
	// populates the manufacturer, style and options dropdown   ---ends    
 
    
// this code peforms the action needed when the seacrh button is clicked
$(document).ready(function()
	{ 
	...
	//create object of window and set the values selected in the dropdown
...
// display the result page through an ajax call
	...
	$('a.control').live('click', function (e) {
		...
		//handles the swapping of rows in the result grid.
            	...
            	<div class="main_content">
                    ...
                    <div class="register_form">
                        <div class="lft_panel_srch">
                            ...
                            <div class="form_btn"><input type="button" value="SEARCH" id="search_button" class="login_btn"  style="cursor:pointer"/></div>
                            <div class="clear"></div>
                        </div>
                        </div>
